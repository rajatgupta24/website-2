...
export const dedicatedPricingPlans: Pricing[] = [
	{
		...
		btnHref: '/contact/sales?subject=Dedicated%20self-serve',
...
export const dedicatedFeatures: FeatureList[] = [
	{
		...
		description: 'Hosted by you, managed by Gitpod.',
		features: [
			`<div class='block'><b>Enhanced security:</b> isolated, single-tenant installations ensure source code, dependencies and dev environments remain private and protected</div>`,
			...
			`<div class='block'><b>Isolated resources:</b> single-tenancy allows for resources allocated exclusively to your organization, avoiding potential resource contention</div>`,
