...
<svelte:head>
	...
	<link
		rel="preload"
		as="image"
		href="/images/illustrattion-large-dark.webp"
	/>
</svelte:head>
...
>
	...
	>
		CDEs are on-demand development environments that are pre-configured with
		all tools, libraries and dependencies needed to write and review code.
	</p>
	<div
